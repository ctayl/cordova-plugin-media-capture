...
public class TrimVideoUtils {
    public static void startTrim(File src, File dst, int startMs, int endMs) throws IOException {
        FileDataSourceImpl file = new FileDataSourceImpl(src.getPath());
    ...
    public static int getDuration(File src) throws IOException {
        FileDataSourceImpl file = new FileDataSourceImpl(src.getPath());
        Movie movie = MovieCreator.build(file);
        ...
        for (Track track : tracks) {
            if ("vide".equals(track.getHandler())) {
                duration += ( track.getDuration() / track.getTrackMetaData().getTimescale());
            }
        }
